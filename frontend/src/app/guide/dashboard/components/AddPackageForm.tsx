...
export function AddPackageSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      apiFormData.append("guide", "current-guide-id") // Replace with actual guide ID
      ...
      // await createPackage(apiFormData)
      ...
      toast(`Package Created, Your travel package has been successfully created.`)
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Create a new travel package for your clients</p>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Add the destinations included in this package</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Describe what makes this package special</CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <Badge variant="secondary">{formData.locations.filter((loc) => loc.trim() !== "").length}</Badge>
                </div>
                <div className="flex justify-between text-sm">
