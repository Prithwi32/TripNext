...
import { Compass, MapPin, Plane, Palmtree, Ship, Calendar, ArrowRight } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto pt-28 pb-20 px-4 sm:px-6 md:pt-36 md:pb-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              <p className="text-lg sm:text-xl md:text-2xl text-foreground/80 dark:text-foreground/70 mb-8 max-w-xl mx-auto lg:mx-0">
                Explore breathtaking destinations and plan unforgettable journeys with TripNext, your ultimate travel companion.
              </p>
            </motion.div>
            ...
            {/* Features highlights */}
            <motion.div 
              className="pt-10 grid grid-cols-2 sm:grid-cols-3 gap-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            {/* Floating card - current promotion */}
            <motion.div 
              className="absolute -bottom-5 -right-5 md:right-5 bg-card/80 backdrop-blur-md p-4 rounded-xl shadow-lg border border-border dark:border-white/10 w-64"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-start gap-3 z-50">
                ...
                <div>
                  <h3 className="font-medium text-sm">Summer Special</h3>
                  <p className="text-xs text-muted-foreground mt-1">20% off on all tropical destinations this summer!</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
